...
<div class="wrap">
  <header>
    <h1>🐍 Snake</h1>
    <div>
      <a class="btn" href="../">← Back to Arcade</a>
  ...
  <div class="grid">
    <section class="panel">
      ...
      <div class="touch" id="touchControls" style="display:none">
        <span></span><button class="dpad" data-d="up">▲</button><span></span>
        <button class="dpad" data-d="left">◀</button><button class="dpad" data-d="down">▼</button><button class="dpad" data-d="right">▶</button>
      </div>
      <div class="msg">Controls: Arrow keys / WASD. Mobile: swipe or use the on-screen pad. P = pause.</div>
    </section>
    ...
    <aside class="panel">
      ...
      <p class="msg">Apples give +1. Every 5 apples, speed increases slightly. Don’t hit walls or yourself!</p>
    </aside>
  </div>
</div>
